<?php
/**
 * Página que muestra los torneos para elegir uno y mostrar las estadpisticas de cómo va dicho torneo
 * 
                    ...
                    <?php if ($rows): ?>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <th>
                                    <a href="teamsStats.php?id=<?= $row['id'] ?>" class="btn btn-success">Ver Estadísticas</a>
                                </th>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
