...
$id = $_POST['organizador'];

$organizadores = $objOrganizadorController->readOneOrganizer($id);
?>
<div class="container py-5">
    <div class="card shadow-lg rounded">
        ...
        <div class="card-body">
            <form action="torneosOrganizerInsert.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="organizador" value="<?= $organizadores['id']?>">
                <!-- Nombre del Torneo -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="txtOrganizador" id="organizador" value="<?= htmlspecialchars($organizadores['nombre']) ?>" readonly>
                </div>
